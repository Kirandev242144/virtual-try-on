                    ...
                    {step === 1 && (
                        <div className={styles.stepContainer}>
                            ...
                            <div className={styles.styleContainer}>
                                {['Streetwear', 'Minimal', 'Luxury', 'Casual', 'Party', 'Office', 'Ethnic', 'Vintage', 'Athleisure', 'Trendy', 'Y2K', 'Grunge'].map((style) => (
                                    <div
                                        key={style}
                                        className={`${styles.stylePill} ${selectedStyles.includes(style) ? styles.selected : ''}`}
                                        onClick={() => {
